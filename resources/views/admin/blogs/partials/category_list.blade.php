        ...
        <table class="table table-striped table-hover">
            ...
            @foreach($categoryBlogs as $category)
                <tr>
                    ...
                    <td>{{ $category->name }}</td>
                    <td>
                        <a href="{{ route('admin.blogs_category.edit', $category->id) }}" class="btn btn-info btn-sm">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p>If you delete {{ $category->name }} all the blogs which are in there will be deleted.</p>
                                <ul>
                                    @foreach(getBlogsByCategory($category->id) as $blog)
                                        <li>{{ $blog->title }}</li>
                                    @endforeach
                                </ul>
                            </div>
                            <div class="modal-footer">
                                ...
                                {!! Form::open(['route' => ['admin.blogs_category.destroy', $category->id], 'method' => 'DELETE']) !!}
