                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="h4">Edit - {{ $cardCategory->name }}</h3>
                        </div>
                        <div class="card-body">
                            {!! Form::model($cardCategory, ['route' => ['admin.cards_category.update', $cardCategory->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate', 'id' => 'blogCategoryForm']) !!}
                            {{ csrf_field() }}
                            <div class="row">
