        ...
        <div class="row bg-white has-shadow">
            ...
            <ul class="nav nav-pills mb-3 col-md-8 col-sm-12" id="pills-tab" role="tablist">
                <li class="nav-item col-sm-12 col-md-3">
                    <a class="nav-link active" id="pills-financials-tab" data-toggle="pill" href="#pills-financials" role="tab" aria-controls="pills-financials" aria-selected="true">Financials</a>
                </li>
                <li class="nav-item col-sm-12 col-md-3">
            ...
            <div class="col-sm-12 col-md-4">
                @if(count($categoryFinancials))
                    <a class="btn btn-primary" href="{{ route('admin.financials.create') }}">
                        <i class="fa fa-plus"></i> Financial
                    </a>
                @endif
