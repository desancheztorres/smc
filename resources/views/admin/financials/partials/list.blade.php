@if(count($categoryFinancials))
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Deleting {{$financial->name}}</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <img src="{{ asset('images/admin/'.$financial->logo) }}" class="mx-auto d-block img-responsive">
                                </div>
    ...
    @else
        <div class="error-body text-center">
            <h2>There are no Financials to show</h2>
            <h3 class="text-uppercase">Please add a new Financial car</h3>
            <a href="{{ route('admin.financials.create') }}" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Add Financial</a>
        </div>
        <hr>
    @endif
@else
