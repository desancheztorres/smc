                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="h4">Edit - {{ $loanCategory->name }}</h3>
                        </div>
                        <div class="card-body">
                            {!! Form::model($loanCategory, ['route' => ['admin.loans_category.update', $loanCategory->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate', 'id' => 'blogCategoryForm']) !!}
                            {{ csrf_field() }}
                            <div class="row">
