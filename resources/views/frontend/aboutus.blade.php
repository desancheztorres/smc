                ...
                <div class="section " style="padding-top:0px; padding-bottom:0px; background-color:">
                    <div class="section_wrapper clearfix">
                        <div class="items_group clearfix">
                            ...
                            <p>Search My Credit helps consumers understand and take better control of their own financial status, allowing each individual to be more confident in the financial decisions they make. Search My Credit provides customers with a tailored solution to their credit needs based off their credit score.
                                <br>
                                <br>
                                Our partner company, Callcredit Consumer Limited will provide you access to your credit report.</p>
                        </div> <div class="column one column_divider">
                            <br>
                        </div>
